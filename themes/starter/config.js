...
const CONFIG = {
  ...
  // 英雄区配图，如需隐藏，改为空值即可 ''
  STARTER_HERO_PREVIEW_IMAGE: 'https://cdn.prod.website-files.com/5bff8886c3964a992e90d465/5c00621b7aefa4f9ee0f4303_wide-shot.svg', // 产品预览图 ，默认读取public目录下图片
  ...
  STARTER_NAV_BUTTON_2_TEXT: 'Github',
  STARTER_NAV_BUTTON_2_URL: 'https://github.com/',
  STARTER_NAV_BUTTON_2_ICON: '/images/starter/github.svg', 
  ...
  STARTER_CONTACT_EMAIL_TEXT: 'hi#haphat.net',

  // 嵌入外部表单
  STARTER_CONTACT_MSG_EXTERNAL_URL: 'https://noteforms.com/forms/tiaoma-cunejw', // 基于NoteForm创建，将留言数据存在Notion中
  //   自定义留言表单，以下几个配置暂时废弃
  ...
  STARTER_FOOTER_BLOG_LATEST_TITLE: '新闻动态',
